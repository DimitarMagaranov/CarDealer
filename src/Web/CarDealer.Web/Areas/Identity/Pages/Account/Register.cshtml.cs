namespace CarDealer.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { UserName = this.Input.UserName, Email = this.Input.Email, Age = this.Input.Age, CountryId = this.Input.CountryId, FirstName = this.Input.FirstName, LastName = this.Input.LastName, PhoneNumber = this.Input.PhoneNumber };
